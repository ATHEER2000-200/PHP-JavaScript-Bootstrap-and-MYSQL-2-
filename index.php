...
<nav class="navbar navbar-expand-lg navbar-dark bg-info">
  <a class="navbar-brand" href="#">  أثير للورود</a>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="#">ورود طبيعية</a>
      </li>
    </ul>
...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
     ...
     <img src="images/profile.jpg" style="border-radius: 50%; vertical-align: middle;width: 200px;height: 200px;" alt="" >
       <h1 class="display-4 fw-normal text-info">اربح معنا </h1>
       <p class="lead fw-normal">باقي على فتح التسجيل</p>
       <div id="demo"></div>
       <p class="lead fw-normal text-info">اشترك الان وادخل المسابقة</p>
       <a class="btn btn-outline-secondary" href="#">Coming soon</a>
     </div>
     <div class="container">
     <ul class="list-group">
      <li class="list-group-item list-group-item-info" aria-current="true">منتجات جديدة</li>
      <li class="list-group-item">ورود طبيعيه</li>
      <li class="list-group-item">ورود صناعية</li>
      <li class="list-group-item">الباقات المتوفرة</li>
      <li class="list-group-item">باقات خاصة</li>
     </ul>
